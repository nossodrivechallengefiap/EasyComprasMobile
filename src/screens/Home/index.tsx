        ...
        <View style={styles.container}>
            ...
            <View style={styles.botoesContainer}>
                ...
                <View style={styles.botaoWrapper}>
                    ...
                    >
                        <Image source={require('../../assets/images/lente.png')} style={styles.imagemBotao} />
                    </TouchableOpacity>
                ...
                <View style={styles.botaoWrapper}>
                    ...
                    >
                        <Image source={require('../../assets/images/cotacao.png')} style={styles.imagemBotao} />
                    </TouchableOpacity>
            ...
            <View style={styles.botoesContainer}>
                ...
                <View style={styles.botaoWrapper}>
                    ...
                    >
                        <Image source={require('../../assets/images/contato.png')} style={styles.imagemBotao} />
                    </TouchableOpacity>
                ...
                <View style={styles.botaoWrapper}>
                    ...
                    >
                        <Image source={require('../../assets/images/parceria.png')} style={styles.imagemBotao} />
                    </TouchableOpacity>
